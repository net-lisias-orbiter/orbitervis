...
class D3D9ParticleStream: public oapi::ParticleStream {
public:
...
protected:
	...
	D3DMATRIX mWorld;
	LPDIRECT3DTEXTURE9 tex; // particle texture

//private:
	double ipht2;

protected:
	oapi::D3D9Client *d3d9c;
	static LPDIRECT3DTEXTURE9 deftex; // default particle texture
