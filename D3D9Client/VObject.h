...
public:
	 ...
	 */
	static void GlobalInit (const oapi::D3D9Client *gclient);
	 ...
	 * \param context event parameters (event type-dependent)
	 * \default None.
	 * \note Supported event types depend on the object type.
	 */
	virtual void NotifyEvent (DWORD event, void *context) {}
...
protected:
	static const oapi::D3D9Client *gc; // graphics client instance pointer
