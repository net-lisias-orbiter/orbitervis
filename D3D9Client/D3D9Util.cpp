...
*/
	FLOAT pM[16];
	D3DXMatrixMultiply((LPD3DXMATRIX)pM, (LPD3DXMATRIX)b, (LPD3DXMATRIX)a);
...
//	D3DXVECTOR4 out;
//	D3DXVec3Transform(&out, (LPD3DXVECTOR3)v, (LPD3DXMATRIX)mat);
...
*/
	D3DXMATRIX temp;
	return D3DXMatrixInverse((LPD3DXMATRIX)res, NULL, (LPD3DXMATRIX)a) == NULL ? E_INVALIDARG : S_OK;
}
